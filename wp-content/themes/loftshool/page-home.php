            ...
            <div class="posts-list">
                ...
                <div class="post-wrap">
                    <div class="post-thumbnail"><img
                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/post_thumb/thumb_1.jpg"
                    ...
                    <div class="post-content">
                        ...
                        <div class="post-content__post-control"><a href="#" class="btn-read-post">Читать далее
                                >></a></div>
                    </div>
                </div>
                <!-- post-mini_end-->
                ...
                <div class="post-wrap">
                    <div class="post-thumbnail"><img
                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/post_thumb/thumb_2.jpg"
                                alt="Image поста" class="post-thumbnail__image"></div>
                    <div class="post-content">
                        <div class="post-content__post-info">
                            <div class="post-date">29.07.2016</div>
                ...
                <div class="post-wrap">
                    <div class="post-thumbnail"><img
                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/post_thumb/thumb_3.jpg"
                                alt="Image поста" class="post-thumbnail__image"></div>
                    <div class="post-content">
                        <div class="post-content__post-info">
                            <div class="post-date">29.07.2016</div>
